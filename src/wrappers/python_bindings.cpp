...
#include "bbcore/page.hpp"
#include "bbcore/blank_block.hpp"

//#include "bbcore/pattern_classifier.hpp"
//#include "bbcore/pattern_pooler.hpp"
...
PYBIND11_MODULE(bb_backend, m) {
    ...
    py::class_<Page>(m, "Page")
        ...
        .def("get_child", &Page::get_child, "Get a particular child page by index", "child_index"_a)
        .def("set_bits", &Page::set_bits, "Set a particular array of bits by the time index", "t"_a, "bits"_a)
        .def("set_acts", &Page::set_acts, "Set a particular array of acts by the time index", "t"_a, "acts"_a)
        .def("get_bits", &Page::get_bits, "Get a particular array of bits by the time index", "t"_a)
        .def("get_acts", &Page::get_acts, "Get a particular array of acts by the time index", "t"_a)
        .def_property_readonly("num_children", &Page::get_num_children, "Get number of children pages") // TODO: cleanup naming convention
        .def_property_readonly("num_history", &Page::get_num_history, "Get number of histories"); // TODO: cleanup naming convention
    ...
    */
    ...
    py::class_<BlankBlock>(m, "BlankBlock")
        ...
        .def("clear", &BlankBlock::clear, "Clear block");
    ...
    py::class_<PatternClassifier>(m, "PatternClassifier")
        ...
        .def("initialize", &PatternClassifier::initialize, "Initialize block")
        .def("save", &PatternClassifier::save, "Save block")
        .def("load", &PatternClassifier::load, "Load block")
        .def("clear", &PatternClassifier::clear, "Clear block")
        .def("compute", &PatternClassifier::compute, "Compute block", "label"_a, "learn"_a);
        //.def("get_statelet_label", &PatternClassifier::get_statelet_label, "Get statelet label")
        //.def("get_probabilities", &PatternClassifier::get_probabilities, "Get label probabilities")
        //.def("decode_bits", &PatternClassifier::decode_bits, "Get decoding in bits");
        //.def("coincidence_set", &PatternClassifier::get_coincidence_set, "Get a particular CoincidenceSet object", "d"_a)
    ...
    py::class_<PatternPooler>(m, "PatternPooler")
        ...
        .def("initialize", &PatternPooler::initialize, "Initialize block")
        .def("save", &PatternPooler::save, "Save block")
        .def("load", &PatternPooler::load, "Load block")
        .def("clear", &PatternPooler::clear, "Clear block")
        .def("compute", &PatternPooler::compute, "Compute block", "learn"_a);
        //.def("coincidence_set", &PatternPooler::get_coincidence_set, "Get a particular CoincidenceSet object", "d"_a)
