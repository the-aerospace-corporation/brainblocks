...
PYBIND11_MODULE(bb_backend, m) {
    ...
    // Pattern Classifier Dynamic
    py::class_<PatternClassifierDynamic>(m, "PatternClassifierDynamic")
        .def(py::init<const uint32_t, const uint32_t, const uint32_t, const uint8_t, const uint8_t, const uint8_t, const double, const double, const double>(), "Construct PatternClassifierDynamic", "labels"_a, "num_s"_a, "num_as"_a, "perm_thr"_a, "perm_inc"_a, "perm_dec"_a, "pct_pool"_a, "pct_conn"_a, "pct_learn"_a)
        .def("initialize", &PatternClassifierDynamic::initialize, "Initialize the Block")
        .def("save", &PatternClassifierDynamic::save, "Save Block memories", "file_str"_a)
        .def("load", &PatternClassifierDynamic::load, "Load Block memories", "file_str"_a)
        .def("clear_states", &PatternClassifierDynamic::clear_states, "Clear states in the Block")
        .def("compute", &PatternClassifierDynamic::compute, "Compute Block", "label"_a, "learn"_a)
        .def("get_labels", &PatternClassifierDynamic::get_labels, "Get Block labels")
        .def("get_probabilities", &PatternClassifierDynamic::get_probabilities, "Get Block labels")
        .def("get_score", &PatternClassifierDynamic::get_score, "Get abnormality score")
        .def("output_coincidence_set", &PatternClassifierDynamic::get_output_coincidence_set, "Get a particular output CoincidenceSet object", "d"_a, py::return_value_policy::reference_internal)
        .def_property_readonly("input", &PatternClassifierDynamic::get_input, "Get input Page object")
        .def_property_readonly("output", &PatternClassifierDynamic::get_output, "Get output Page object");
    ...
    // Context Learner
    py::class_<ContextLearner>(m, "ContextLearner")
        .def(py::init<const uint32_t, const uint32_t, const uint32_t, const uint32_t, const uint8_t, const uint8_t, const uint8_t>(), "Construct ContextLearner", "num_spc"_a, "num_dps"_a, "num_rpd"_a, "d_thresh"_a, "perm_thr"_a, "perm_inc"_a, "perm_dec"_a)
        .def("initialize", &ContextLearner::initialize, "Initialize the Block")
        .def("save", &ContextLearner::save, "Save Block memories", "file_str"_a)
        .def("load", &ContextLearner::load, "Load Block memories", "file_str"_a)
        .def("clear_states", &ContextLearner::clear_states, "Clear states in the Block")
        .def("compute", &ContextLearner::compute, "Compute Block", "learn"_a)
        .def("get_score", &ContextLearner::get_score, "Get abnormality score")
        .def("output_coincidence_set", &ContextLearner::get_output_coincidence_set, "Get a particular output CoincidenceSet object", "d"_a, py::return_value_policy::reference_internal)
        .def_property_readonly("input", &ContextLearner::get_input, "Get input Page object")
        .def_property_readonly("context", &ContextLearner::get_context, "Get hidden Page object")
        .def_property_readonly("output", &ContextLearner::get_output, "Get output Page object");
